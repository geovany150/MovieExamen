                ...
                new MaterialFavoriteButton.OnFavoriteChangeListener() {
                    ...
                    public void onFavoriteChanged(MaterialFavoriteButton buttonView, boolean favorite) {
                        if (favorite) {
                            ...
                            Snackbar.make(buttonView, modelTV.getName() + getResources().getString(R.string.addfavorite),
                                    Snackbar.LENGTH_SHORT).show();
                        } else {
                            helper.deleteFavoriteTV(modelTV.getId());
                            Snackbar.make(buttonView, modelTV.getName() + getResources().getString(R.string.removefaforite),
                                    Snackbar.LENGTH_SHORT).show();
                        }
