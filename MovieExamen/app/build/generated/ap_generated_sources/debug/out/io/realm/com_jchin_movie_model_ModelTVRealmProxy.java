...
public class com_jchin_movie_model_ModelTVRealmProxy extends com.jchin.movie.model.ModelTV
    implements RealmObjectProxy, com_jchin_movie_model_ModelTVRealmProxyInterface {
    ...
    private ProxyState<com.jchin.movie.model.ModelTV> proxyState;

    com_jchin_movie_model_ModelTVRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.jchin.movie.model.ModelTV>(this);
    ...
    @SuppressWarnings("cast")
    public static com.jchin.movie.model.ModelTV createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.jchin.movie.model.ModelTV obj = realm.createObjectInternal(com.jchin.movie.model.ModelTV.class, true, excludeFields);

        final com_jchin_movie_model_ModelTVRealmProxyInterface objProxy = (com_jchin_movie_model_ModelTVRealmProxyInterface) obj;
        if (json.has("Id")) {
            if (json.isNull("Id")) {
    ...
    public static com.jchin.movie.model.ModelTV createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.jchin.movie.model.ModelTV obj = new com.jchin.movie.model.ModelTV();
        final com_jchin_movie_model_ModelTVRealmProxyInterface objProxy = (com_jchin_movie_model_ModelTVRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.jchin.movie.model.ModelTV copyOrUpdate(Realm realm, com.jchin.movie.model.ModelTV object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.jchin.movie.model.ModelTV) cachedRealmObject;
        }

        return copy(realm, object, update, cache);
    }

    public static com.jchin.movie.model.ModelTV copy(Realm realm, com.jchin.movie.model.ModelTV newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.jchin.movie.model.ModelTV realmObject = realm.createObjectInternal(com.jchin.movie.model.ModelTV.class, false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_jchin_movie_model_ModelTVRealmProxyInterface realmObjectSource = (com_jchin_movie_model_ModelTVRealmProxyInterface) newObject;
        com_jchin_movie_model_ModelTVRealmProxyInterface realmObjectCopy = (com_jchin_movie_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.jchin.movie.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.jchin.movie.model.ModelTV.class);
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.jchin.movie.model.ModelTV.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.IdIndex, rowIndex, ((com_jchin_movie_model_ModelTVRealmProxyInterface) object).realmGet$Id(), false);
        String realmGet$Name = ((com_jchin_movie_model_ModelTVRealmProxyInterface) object).realmGet$Name();
        if (realmGet$Name != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.NameIndex, rowIndex, realmGet$Name, false);
        }
        Table.nativeSetDouble(tableNativePtr, columnInfo.VoteAverageIndex, rowIndex, ((com_jchin_movie_model_ModelTVRealmProxyInterface) object).realmGet$VoteAverage(), false);
        String realmGet$Overview = ((com_jchin_movie_model_ModelTVRealmProxyInterface) object).realmGet$Overview();
        if (realmGet$Overview != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.OverviewIndex, rowIndex, realmGet$Overview, false);
        }
        String realmGet$ReleaseDate = ((com_jchin_movie_model_ModelTVRealmProxyInterface) object).realmGet$ReleaseDate();
        ...
        String realmGet$PosterPath = ((com_jchin_movie_model_ModelTVRealmProxyInterface) object).realmGet$PosterPath();
        ...
        String realmGet$BackdropPath = ((com_jchin_movie_model_ModelTVRealmProxyInterface) object).realmGet$BackdropPath();
        ...
        String realmGet$Popularity = ((com_jchin_movie_model_ModelTVRealmProxyInterface) object).realmGet$Popularity();
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        ModelTVColumnInfo columnInfo = (ModelTVColumnInfo) realm.getSchema().getColumnInfo(com.jchin.movie.model.ModelTV.class);
        com.jchin.movie.model.ModelTV object = null;
        while (objects.hasNext()) {
            object = (com.jchin.movie.model.ModelTV) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.jchin.movie.model.ModelTV object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.jchin.movie.model.ModelTV.class);
    ...
    public static com.jchin.movie.model.ModelTV createDetachedCopy(com.jchin.movie.model.ModelTV realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.jchin.movie.model.ModelTV unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.jchin.movie.model.ModelTV();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.jchin.movie.model.ModelTV) cachedObject.object;
            }
            unmanagedObject = (com.jchin.movie.model.ModelTV) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_jchin_movie_model_ModelTVRealmProxyInterface unmanagedCopy = (com_jchin_movie_model_ModelTVRealmProxyInterface) unmanagedObject;
        com_jchin_movie_model_ModelTVRealmProxyInterface realmSource = (com_jchin_movie_model_ModelTVRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_jchin_movie_model_ModelTVRealmProxy aModelTV = (com_jchin_movie_model_ModelTVRealmProxy)o;
